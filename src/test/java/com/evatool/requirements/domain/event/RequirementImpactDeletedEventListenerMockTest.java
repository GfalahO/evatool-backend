...
class RequirementImpactDeletedEventListenerMockTest {
    ...
    void testOnApplicationEvent_PublishEvents_ReceivePublishedEvents(int value) {
        for (int i = 0; i < value; i++) {
            // given
            ImpactDeletedEvent impactDeletedEvent = new ImpactDeletedEvent(applicationEventPublisher,"");
        ...
        // then
        verify(requirementEventListener, times(value)).impactDeleted(any(ImpactDeletedEvent.class));
    }
    ...
    void testOnApplicationEvent_PublishWrongEvent_DoNotReceive() {
        ...
        // then
        verify(requirementEventListener, times(0)).impactDeleted(any(ImpactDeletedEvent.class));
    }
