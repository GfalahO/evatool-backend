...
class RequirementDimensionCreateEventListenerMockTest {
    ...
    void testOnApplicationEvent_PublishEvents_ReceivePublishedEvents(int value) {
        for (int i = 0; i < value; i++) {
            // given
            DimensionCreatedEvent dimensionCreatedEvent = new DimensionCreatedEvent(applicationEventPublisher,"");
        ...
        // then
        verify(requirementEventListener, times(value)).dimensionCreated(any(DimensionCreatedEvent.class));
    }
