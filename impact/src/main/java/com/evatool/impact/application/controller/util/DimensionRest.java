...
public class DimensionRest {
    ...
    public static final String DIMENSION_REST_CONTROLLER_MAPPING = BASE_URI + "/dimensions";

    public static final String DIMENSIONS = "dimensions";

    public static final String GET_DIMENSION_MAPPING = "/{id}";
    public static final String GET_DIMENSIONS_MAPPING = "";
    public static final String POST_DIMENSION_MAPPING = "";
    public static final String PUT_DIMENSION_MAPPING = "/{id}";
    public static final String DELETE_DIMENSION_MAPPING = "/{id}";
